...
// Add these to the handleGet method in SerialConsole.cpp
// Inside the handleGet function, add a new else if block:
...
// Add these to the handleSet method in SerialConsole.cpp
// Inside the handleSet function, add a new else if block:
